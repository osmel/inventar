				...
				<div class="col-sm-6 col-md-6">
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-10">
							...
							?>
							<input value="<?php echo  set_value('color',$nomb_nom); ?>" type="text" class="form-control" name="color" placeholder="color">
						</div>
					</div>
						...
						<span class="mini-bloque">
							...
							<div class="col-sm-9 col-md-10">
								<div id="colorPicker"></div>
										...
										?>
									<input type="text" id="hexadecimal_color" name="hexadecimal_color" placeholder="Color" value="<?php echo  set_value('hexadecimal_color',$nomb_nom); ?>" class="colorSelector">
