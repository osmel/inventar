					...
					<div class="col-sm-12 col-md-12 control" style="margin-bottom:10px">						
						<div class="col-sm-2 col-md-2">
							<div class="form-group">
								<label for="label_vendedor" id="label_vendedor" class="col-sm-12 col-md-12">Num. Mov</label>
						...
						<div class="col-md-12">	
							<div class="row">
								...
								<div class="col-sm-3 col-md-3">
									...
									<a href="<?php echo base_url(); ?>generar_pedido_especifico/<?php echo base64_encode($mov_salida); ?>/<?php echo base64_encode(3); ?>/<?php echo base64_encode($id_apartado); ?>"  
