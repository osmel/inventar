...
<?php
 ...
 $hidden = array('id'=>$id); ?>
<?php echo form_open('validar_eliminar_prod_temporal', array('class' => 'form-horizontal','id'=>'form_catalogos','name'=>$retorno, 'method' => 'POST', 'role' => 'form', 'autocomplete' => 'off' ) ,   $hidden ); ?>
