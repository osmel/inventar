				...
				<?php if ( isset($movimientos) && !empty($movimientos) ): ?>
					<?php foreach( $movimientos as $movimiento ): ?>
						<tr>
							...
							<td width="17%" style="border-top: 1px solid #222222;"><?php echo $movimiento->id_descripcion; ?></td>
							...
							<td width="6%" style="border-top: 1px solid #222222;"><?php echo $movimiento->cantidad_um; ?></td>
