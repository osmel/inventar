									...
									<td style="height: 378px; text-align: center; vertical-align: middle;">
										<table style="display: inline-block; text-align: left; width: 358px; border: 1px solid #000000;">
											<tbody>
												...
												<tr>
													<td style="font-size: 10px;">
														<p style="margin-top: 10px; line-height: 10px;">
															...
															&nbsp;V.Carranza 140 Col. Centro<br>
															&nbsp;Mexico, D.F. C.P. 06060<br>
															&nbsp;Tel 5542 5305 Fax:5542 1430<br>
															&nbsp;RFC: 000000000000
														</p>
													</td>
												...
												<tr>
													<td style="text-align: left;">
														<p style="margin-left: 10px; font-size: 20px;"><b><?php echo $movimiento->id_descripcion?></b></p>
													</td>
