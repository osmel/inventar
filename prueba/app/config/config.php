...
*/
$config['base_url']	='http://inventarios.dev.com/'; // 'http://45.55.85.45';
...
*/
$config['permittinven_uri_chars'] = '+=\a-z 0-9~%.:_-'; 
...
$config['sess_cookie_name']		= 'inven_session';
...
$config['sess_table_name']		= 'inven_sessions'; //'ci_sessions';
...
| addresses from which CodeIgniter should trust the HTTP_X_FORWARDinven_FOR
