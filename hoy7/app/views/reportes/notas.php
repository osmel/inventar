				...
				<table class="table table-striped table-bordered table-responsive tabla_ordenadas" >
					<thead>	
						<tr>
							...
							<th class="text-center cursora" width="20%">Factura  <i class="glyphicon glyphicon-sort"></i></th>
						...
						<?php foreach( $entradas  as $entrada  ): ?>
							<tr style="color:<?php echo $entrada->color_devolucion?>">
								...
								<td class="text-center"><?php echo $entrada->factura ; ?></td>
								 <td>
									<a style="  padding: 1px 0px 1px 0px;" href="<?php echo base_url(); ?>procesar_entradas/<?php echo base64_encode($entrada->movimiento); ?>/<?php echo base64_encode($entrada->devolucion); ?>" 
