...
<div class="container margenes">
			...
			<div class="panel-heading">Número de Movimiento: <?php echo $encabezado['num_movimiento']; ?></div>
			<div class="panel-body">
				...
				<div class="col-sm-4 col-md-4" style="margin-bottom:25px">
					...
					<a href="<?php echo base_url(); ?>generar_salida/<?php echo base64_encode($encabezado['num_movimiento']); ?>"  
			...
			<div class="col-md-12">
				...
				<table class="table table-striped table-bordered table-responsive tabla_ordenadas" >
					<thead>	
						<tr>
							<th class="text-center cursora" style="width:30%">Código<i class="glyphicon glyphicon-sort"></i></th>
							<th class="text-center cursora" style="width:10%">Descripción <i class="glyphicon glyphicon-sort"></i></th>
							...
							<th class="text-center cursora" style="width:10%">Lote<i class="glyphicon glyphicon-sort"></i></th>
