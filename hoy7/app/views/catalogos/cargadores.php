		...
		<div class="panel panel-primary">
			...
			<div class="col-md-12">
				...
				<table class="table table-striped table-bordered table-responsive tabla_ordenadas" >
					<thead>	
						<tr>
							<th class="text-center cursora" width="70%">Cargador   <i class="glyphicon glyphicon-sort"></i></th>
							<th class="text-center " width="5%"><strong>Editar</strong></th>
							<th class="text-center " width="5%"><strong>Eliminar</strong></th>

						</tr>
					</thead>		
					<?php if ( isset($cargadores) && !empty($cargadores  ) ): ?>
						<?php foreach( $cargadores   as $cargador   ): ?>
							<tr>
								
								<td class="text-center"><?php echo $cargador->nombre  ; ?></td>
								 <td>
									<a href="<?php echo base_url(); ?>editar_cargador/<?php echo $cargador->id; ?>" type="button" 
									class="btn btn-warning btn-sm btn-block" >
										<span class="glyphicon glyphicon-edit"></span>
									</a>
								</td>
								<td>
									<a href="<?php echo base_url(); ?>eliminar_cargador/<?php echo $cargador->id; ?>/<?php echo base64_encode($cargador->nombre) ; ?>"  
					...
					<?php else : ?>
							<tr>
								<td colspan="5">No existen cargadores  </td>
							</tr>
					<?php endif; ?>						
