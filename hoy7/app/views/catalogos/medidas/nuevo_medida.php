...
<?php 
 ...
 echo form_open('validar_nuevo_unidad_medida', $attr);
?>		
<div class="container">
		<br>	
	<div class="row">
		<div class="col-sm-8 col-md-8"><h4>Nueva unidad medida</h4></div>
	</div>
	<br>
			...
			<div class="panel-body">
				<div class="col-sm-6 col-md-6">
					<div class="form-group">
						<label for="medida" class="col-sm-3 col-md-2 control-label">U.M.</label>
