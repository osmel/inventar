...
<?php echo form_open('validando_eliminar_usuario', array('class' => 'form-horizontal', 'id' => 'form_usuarios','name'=>'form_eliminar', 'method' => 'POST', 'role' => 'form', 'autocomplete' => 'off' ) ,   $hidden ); ?>
