...
-->
		...
		<div class="row">
			...
			<div class="col-sm-4 col-md-4">
				<a style="padding:8px;" href="<?php echo base_url(); ?>procesar_entradas/<?php echo base64_encode("-1") ; ?>/<?php echo base64_encode("0") ; ?>" type="button" class="btn btn-success btn-block">Procesar</a>
			</div>
		</div>
<br>
	</div>	
