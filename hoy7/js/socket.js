...
/*
              case "incluir_salida":
                     mensaje_notif=  "Incluye apartado de vendedor actualizo inventario";
                     caja_notificacion = '.notif-bot-pedidos';
                  break;


              case "incluir_pedido":
                     mensaje_notif=  "Incluye apartado de tienda actualizo inventario";
                     caja_notificacion = '.notif-bot-pedidos';
                  break;     


              case "excluir_salida":
                     mensaje_notif=  "Excluye apartado de vendedor actualizo inventario";
                     caja_notificacion = '.notif-bot-pedidos';
                  break;


              case "excluir_pedido":
                     mensaje_notif=  "Excluye apartado de tienda actualizo inventario";
                     caja_notificacion = '.notif-bot-pedidos';
                  break;     
*/
    ...
    if  ( (hash_url=="/pedidos")  ) {
        ...
        $('#tabla_pedido').dataTable().fnDraw();
          ...
          switch(data.tipo) {
              ...
              case "incluir_salida":
                     mensaje_notif=  "Incluye pedido de vendedor";
                     caja_notificacion = '.notif-bot-vendedor';
                  break;
              case "incluir_pedido":
                     mensaje_notif=  "Incluye pedido de tienda";
                     caja_notificacion = '.notif-bot-tienda';
                  break;

              //excluye apartados y pedidos de vendedor y tienda
              case "excluir_salida":
                     mensaje_notif=  "Excluye pedido de vendedor";
                     caja_notificacion = '.notif-bot-vendedor';
                  break;
              case "excluir_pedido":
                     mensaje_notif=  "Excluye pedido de tienda";
                     caja_notificacion = '.notif-bot-tienda';
                  break;
